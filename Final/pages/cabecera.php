                        ...
                        <ul class="nav navbar-nav">
                            ...
                            <li class="dropdown messages-menu">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li>
                                        ...
                                        <ul class="menu">
                                            ...
                                            <li><!-- start message -->
                                                <a href="#">
                                                    <div class="pull-left">
                                                        <img src="ui/dist/img/<?php echo $value['imagen'] ?>.jpg" class="img-circle" alt="User Image">
                                                    </div>
                                                    <h4>
                                                        <?php echo $value['asunto'] ?>
                                                        <small><i class="fa fa-clock-o"></i> <?php echo $value['time'] ?></small>
                                                    </h4>
                                                    <p><?php echo $value['mensajeCorto'] ?></p>
                                                </a>
                                            </li><!-- end message -->
                                            <?php
                                                }
                                    ...
                                    <li class="footer"><a href="#">Ver más mensajes</a></li>
                                </ul>
                            </li>
                            ...
                            <li class="dropdown user user-menu">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li class="user-header">
                                        ...
                                        <p>
                                            <?php echo $_SESSION['nombre']; ?> - <?php echo $_SESSION['puesto']; ?>
                                    ...
                                    <li class="user-footer">
                                        ...
                                        <div class="pull-right">
                                            <a href="pages/cerrarSesion.php" class="btn btn-default btn-flat">Sign out</a>
                                        </div>
                                    </li>
                                </ul>
                            </li>
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li>
                            <a href="<?php echo $value['url']; ?>" 
                               onclick="<?php echo $value['onclick']; ?>">
                                <i class="fa <?php echo $value['icono']; ?>"></i> <span><?php echo $value['item'];?></span>
